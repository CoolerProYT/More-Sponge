package com.coolerpromc.moresponge.entity.model;
...
public class SpongeTraderModel extends EntityModel<SpongeTraderRenderState> implements HeadedModel, VillagerLikeModel<SpongeTraderRenderState> {
    private final ModelPart head;
    private final ModelPart rightLeg;
    private final ModelPart leftLeg;
    private final ModelPart arms;

    public SpongeTraderModel(ModelPart root) {
        super(root);
    ...
    public void setupAnim(SpongeTraderRenderState state) {
    ...
    public void translateToArms(SpongeTraderRenderState state, PoseStack outputPoseStack) {
